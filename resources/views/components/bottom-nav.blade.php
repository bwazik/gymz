    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('dockPill', () => ({
            ...
            init() {
                ...
                setTimeout(() => {
                    const activeTab = this.tabs.find(t => t.dataset.active === 'true') || this.tabs[0];
            ...
            snapTo(targetEl, instant = false) {
                ...
                if (instant) {
                    ...
                    this.pill.style.transition = 'transform 0.4s cubic-bezier(0.32,0.72,0,1), width 0.4s cubic-bezier(0.32,0.72,0,1)';
                }
            ...
            touchMove(e) {
                ...
                const maxLeft = -(this.$el.getBoundingClientRect().width - this.tabs[this.tabs.length - 1].getBoundingClientRect().width - padding);
                this.currentTranslateX = Math.min(maxRight, Math.max(maxLeft, this.currentTranslateX));
