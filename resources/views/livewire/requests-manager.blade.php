            ...
            <x-glass-card class="mb-4">
                ...
                <div class="flex items-center gap-3">
                    <button wire:click="acceptRequest({{ $request->id }})" wire:loading.attr="disabled"
                        ...
                        <span wire:loading wire:target="acceptRequest({{ $request->id }})">اتقل...</span>
                    </button>
                    <button
                    ...
                    <div class="mt-4 pt-3 border-t border-black/5 dark:border-white/5">
                        @php
                            if ($request->status === \App\Enums\RequestStatus::Pending) {
                                ...
                                $alertTitle = 'إلغاء اتفاق مؤكد';
                                $alertMessage =
                                    'المستضيف وافق عليك خلاص! لو لغيت دلوقتي هيتخصم 5% من الموثوقية بتاعتك.. متأكد؟';
                            }
                        @endphp
